...
6. Add labels to match your config (if you don't them yet). For the sake of this tutorial, if you don't have a "feature" label, please create one.
...
4. Commit, push, and open a PR for this branch
   ...
   PR Labeler will start working to label this PR if you installed it with the steps above. If not, add a label to your PR that matches one of the labels in the config above.

5. Merge your PR into `master`

   If you visit the "Actions" tab, you should see Release Drafter working.
