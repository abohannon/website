...
4. Commit, push, and open a PR for this branch
   ...
   PR Labeler will start working to label this PR if you installed it with the steps above. If not, manually add a label to your PR that matches one of the labels in the config above, like "feature".
